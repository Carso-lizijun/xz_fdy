        ...
        <div class="content">
            ...
            <form class="register-form">
                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">用户名</label>
                    <div id="input-error">
                    	<input class="form-control placeholder-no-fix" type="text" value="lee" placeholder="用户名" name="username" />
                    </div> 
                </div>
                <div class="form-group">
                    <label class="control-label visible-ie8 visible-ie9">密码</label>
                    <div id="input-error">
                    	<input class="form-control placeholder-no-fix" type="text" value="lee" placeholder="密码" name="password" />
                    </div> 
                </div>
