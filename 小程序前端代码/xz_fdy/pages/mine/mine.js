...
Page({
  ...
  onLoad: function(params) {
    var me = this;
    var publicherId = params.publicherId;
    var serverUrl = app.serverUrl;
    var user = app.getGlobalUserInfo();
    var userId = user.id;
    if (publicherId != null && publicherId != '' && publicherId != undefined) {
      userId = publicherId;
      me.setData({
        isMe: false,
        publicherId: publicherId
      })
    }
    ...
    wx.request({
      ...
      success: function(res) {
        ...
        if (res.data.status == 200) {
          ...
          if (userInfo.faceImage != null && userInfo.faceUrl != '' && userInfo.faceImage != undefined) {
  ...
  followMe: function(e) {
    var me = this;
    var serverUrl = app.serverUrl;
    var publicherId = me.data.publicherId;
    var user = app.getGlobalUserInfo();
    var userId = user.id;
    ...
    var url = '';
    if (followType == '1') {
      url = '/user/beyourfans?userId=' + publicherId + "&fanId=" + user.id;
    } else {
      url = '/user/dontbeyourfans?userId=' + publicherId + "&fanId=" + user.id;
    }
    wx.showLoading();
    wx.request({
      url: serverUrl + url,
